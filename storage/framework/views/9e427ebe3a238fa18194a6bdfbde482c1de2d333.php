    ...
    <div class="form-group row col-6">
      <?php echo Form::label('car_id', 'Car Id:', ['class' => 'col-3 control-label text-right']); ?>

      <div class="col-9">
        <p><?php echo $car->id; ?></p>
        <?php echo Form::text('id',$car->id, ['class' => 'col-3 control-label text-right','hidden'=>true]); ?>
    ...
    </div><?php /**PATH /opt/lampp/htdocs/Back_End/resources/views/car/show_fields.blade.php ENDPATH**/ ?>