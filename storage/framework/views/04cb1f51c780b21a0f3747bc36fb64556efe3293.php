    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          ...
          <li class="breadcrumb-itema ctive"><a href="<?php echo url('car/'); ?>">Car</a>
          </li>
        </ol>
      </div><!-- /.col -->
    </div><!-- /.row -->
...
<div class="content">
  <div class="card">
    ...
    <div class="card-body">
      <div class="row">
          <form method="post" class="row col-12" action="<?php echo e(url('car/update/'.$car->id)); ?>">
              <?php echo $__env->make('car.show_fields', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <div class="form-group col-12 text-right">
                <button type="submit" type="submit" class="btn btn-success"><i class="fa fa-save"></i>Save</button> | 
                <a href="<?php echo route('carts.index'); ?>" class="btn btn-default"><i class="fa fa-undo"></i> <?php echo e(trans('lang.back')); ?></a>
            </div>
          </form>
        <!-- Back Field -->
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/Back_End/resources/views/car/show.blade.php ENDPATH**/ ?>