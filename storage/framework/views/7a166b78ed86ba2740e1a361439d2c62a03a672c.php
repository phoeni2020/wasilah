...
<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('orders.index')): ?>
    ...
    <li class="nav-item has-treeview <?php echo e(Request::is('freight*') ? 'menu-open' : ''); ?>">
        <a href="#" class="nav-link <?php echo e(Request::is('freight*') ? 'active' : ''); ?>"> <?php if($icons): ?>
                <i class="nav-icon fa fa-truck"></i><?php endif; ?>
            <p><?php echo e(trans('lang.freight')); ?> <i class="right fa fa-angle-left"></i>
            </p>
        </a>
        <ul class="nav nav-treeview">
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('orders.index')): ?>
                <li class="nav-item">
                    ...
                    <a class="nav-link <?php echo e(Request::is('freight*') ? 'active' : ''); ?>" href="<?php echo url('/freight/order/pending'); ?>"><?php if($icons): ?>
                            <i class="nav-icon fa fa fa-spinner "></i><?php endif; ?><p><?php echo e(trans('lang.freight_order_pending')); ?></p></a>
                </li>
                <li class="nav-item">

                    <a class="nav-link <?php echo e(Request::is('outbound') ? 'active' : ''); ?>" href="<?php echo url('/freight/order/placed'); ?>"><?php if($icons): ?>
                            <i class="nav-icon fa fa-shopping-bag"></i><?php endif; ?><p><?php echo e(trans('lang.freight_order_placed')); ?></p></a>
                </li>
                <li class="nav-item">
                    
                    <a class="nav-link <?php echo e(Request::is('orders*') ? 'active' : ''); ?>" href="<?php echo url('/freight/order/packed'); ?>"><?php if($icons): ?>
                            <i class="nav-icon fa fa-check-square-o"></i><?php endif; ?><p><?php echo e(trans('lang.freight_order_packed')); ?></p></a>
                </li>
                <li class="nav-item">

                    <a class="nav-link <?php echo e(Request::is('outbound') ? 'active' : ''); ?>" href="<?php echo url('/freight/order/shipped'); ?>"><?php if($icons): ?>
                            <i class="nav-icon fa fa-truck"></i><?php endif; ?><p><?php echo e(trans('lang.freight_order_shipped')); ?></p></a>
                </li>
                <li class="nav-item">

                    <a class="nav-link <?php echo e(Request::is('outbound') ? 'active' : ''); ?>" href="<?php echo url('/freight/order/delivered'); ?>"><?php if($icons): ?>
                            <i class="nav-icon fa fa-thumbs-up"></i><?php endif; ?><p><?php echo e(trans('lang.freight_order_delivered')); ?></p></a>
                </li>
            <?php endif; ?>
        </ul>
    </li>
...
<?php endif; ?><?php /**PATH /opt/lampp/htdocs/wasilah/resources/views/layouts/menu.blade.php ENDPATH**/ ?>