...
use App\DataTables\BanedclintsDataTable;
use App\DataTables\Banedusers_DataTable;
...
class UserController extends Controller
{
    ...
    {
        return $userDataTable->render('clints.index');
    }
    ...
    public function showuser($id)
    {
        ...
        return view('clints.show')->with('user', $user);
    }
    ...
    public function edit_clinte($id)
    {
        if (!auth()->user()->hasRole('admin') && $id != auth()->id()) {
            Flash::error('Permission denied');
            return redirect(route('users.index'));
    ...
    public function baned(BanedclintsDataTable $userDataTable)
    {
        return $userDataTable->render('clints.band');
    }
    public function unban($id){
        //$user = User:: withTrashed()->find($id);
       // 
        $user = $this->userRepository->onlyTrashed()->find($id);
        $user->restore();
        return redirect(url('clint'));
        
    }
    public function allbaned(Banedusers_DataTable $userDataTable){
        return $userDataTable->render('users_banned.band');
    }
    /**
