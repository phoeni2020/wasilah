...
function gettripeStauts($column, $attributeName)
{
    if (isset($column) && $column[$attributeName] == 2) {
        return "<span class='badge badge-success'>" . 'Done' . "</span> ";
    }elseif(isset($column) && $column[$attributeName] == 1) {
        return "<span class='badge badge-warning'>" . 'In Progress' . "</span> ";
    }  
    else {
        return "<span class='badge badge-danger'>" . 'Waiting for confirmation ' . "</span>";
    }
}

function returnuserdata($column, $attributeName , $url)
{
    if (isset($column) && $column[$attributeName[0]] != null) {
        $target = url($url);
        return $link = "<a href='".$target."' class='text-bold text-dark'>".$column[$attributeName[1]]."</a>";
    }
}
/**
...
function getStauts($column, $attributeName)
{
    if (isset($column) && $column[$attributeName] == 1) {
        return "<span class='badge badge-success'>" . 'Done' . "</span> ";
    } else {
        return "<span class='badge badge-danger'>" . trans('lang.order_not_paid') . "</span>";
    }
...
function getMethod($column, $attributeName)
{
    if (isset($column) && $column[$attributeName] == 0) {
        return "<span class='badge badge-success'>" . 'Cash' . "</span> ";
    } else {
        return "<span class='badge badge-success'>" . 'Credit Card' . "</span>";
    }
}
/**
 * @param array $array
