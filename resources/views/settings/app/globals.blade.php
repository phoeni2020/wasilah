        ...
        <div class="card-body">
            ...
            <div class="row">
                <div style="flex: 50%;max-width: 50%;padding: 0 4px;" class="column">
                    ...
                    <!-- kilo price Field -->
                    <div class="form-group row">
                        {!! Form::label('kilo_inbound_price', trans("lang.kilo_inbound_price"), ['class' => 'col-4 control-label text-right']) !!}
                        <div class="col-8">
                            {!! Form::text('kilo_inbound_price', setting('kilo_inbound_price'),  ['class' => 'form-control','placeholder'=>  trans("lang.kilo_price_placeholder")]) !!}
                            <div class="form-text text-muted">
                                {{ trans("lang.app_setting_app_name_help") }}
                            </div>
                        </div>
                    ...
                    <!-- kilo price Field -->
                    <div class="form-group row">
                        {!! Form::label('kilo_outbound_price', trans("lang.kilo_outbound_price"), ['class' => 'col-4 control-label text-right']) !!}
                        <div class="col-8">
                            {!! Form::text('kilo_outbound_price', setting('kilo_outbound_price'),  ['class' => 'form-control','placeholder'=>  trans("lang.kilo_price_placeholder")]) !!}
                            <div class="form-text text-muted">
                                {{ trans("lang.app_setting_app_name_help") }}
                            </div>
                        </div>
                ...
                <div class="form-group mt-4 col-12 text-right">
                    ...
                    <a href="{!! route('users.create') !!}" class="btn btn-default"><i class="fa fa-undo"></i> {{trans('lang.cancel')}}</a>
                </div>
            </div>
            {!! Form::close() !!}
            <div class="clearfix"></div>
